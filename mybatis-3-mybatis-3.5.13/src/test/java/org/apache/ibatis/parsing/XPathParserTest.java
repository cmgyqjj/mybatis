...
//        一个最简单的尝试，通过无参数的XPathParser对XML流进行读取
...
//    和上面一样
    ...
    /**
    *@Param: resource 资源路径
    *@return: Document Mybatis封装XML文档对象
    *@Author: qjj
    *@describe: 从资源路径中取到Docuemnt
    */
